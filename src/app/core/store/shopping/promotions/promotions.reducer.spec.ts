...
describe('Promotions Reducer', () => {
  ...
  describe('LoadPromotion actions', () => {
    describe('LoadPromotionFail action', () => {
      ...
      beforeEach(() => {
        const action = loadPromotionFail({ payload: { error: {} as HttpError, promoId: 'erroneous_promo' } });
      ...
      describe('followed by LoadPromotionSuccess', () => {
        beforeEach(() => {
          ...
          const action = loadPromotionSuccess({ payload: { promotion } });
          state = promotionsReducer(initialState, action);
        });
    ...
    describe('LoadPromotionSuccess action', () => {
      ...
      it('should update promotion if already exists', () => {
        const action1 = loadPromotionSuccess({ payload: { promotion } });
        ...
        const action2 = loadPromotionSuccess({ payload: { promotion: updatedPromotion } });
