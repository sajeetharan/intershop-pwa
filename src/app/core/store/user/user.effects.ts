    ...
    this.actions$.pipe(
      ...
      mergeMap(() =>
        this.userService.getCompanyUserData().pipe(
          ...
          mapErrorToActionV8(loadCompanyUserFail)
        )
      )
    )
  );
    ...
    this.actions$.pipe(
      ...
      concatMap(([payload, customer]) =>
        this.userService.updateUser({ user: payload.user, customer }).pipe(
          ...
          mapErrorToActionV8(updateUserFail)
        )
      )
    )
  );
    ...
    this.actions$.pipe(
      ...
      concatMap(([[payload, customer], user]) =>
        this.userService.updateUserPassword(customer, user, payload.password, payload.currentPassword).pipe(
          ...
          mapErrorToActionV8(updateUserPasswordFail)
        )
      )
    )
  );
    ...
    this.actions$.pipe(
      ...
      concatMap(([payload]) =>
        this.userService.updateCustomer(payload.customer).pipe(
          ...
          mapErrorToActionV8(updateCustomerFail)
        )
      )
    )
  );
    ...
    this.actions$.pipe(
      ...
      concatMap(([, customer]) =>
        this.paymentService.getUserPaymentMethods(customer).pipe(
          ...
          mapErrorToActionV8(loadUserPaymentMethodsFail)
        )
      )
    )
  );
    ...
    this.actions$.pipe(
      ...
      concatMap(([id, customer]) =>
        this.paymentService.deleteUserPaymentInstrument(customer.customerNo, id).pipe(
          ...
          mapErrorToActionV8(deleteUserPaymentInstrumentFail)
        )
      )
    )
  );
    ...
    this.actions$.pipe(
      ...
      concatMap(data =>
        this.userService.requestPasswordReminder(data).pipe(
          map(requestPasswordReminderSuccess),
          mapErrorToActionV8(requestPasswordReminderFail)
        )
      )
    )
  );
    ...
    this.actions$.pipe(
      ...
      concatMap(data =>
        this.userService.updateUserPasswordByReminder(data).pipe(
          ...
          mapErrorToActionV8(updateUserPasswordByPasswordReminderFail)
        )
      )
    )
  );
